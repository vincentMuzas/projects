...
/**
 * Class to generate Oauth 1.0a
 * Found at: https://stackoverflow.com/questions/3756257/absolute-minimum-code-to-get-a-valid-oauth-signature-populated-in-java-or-groovy
 */
public class OauthHeaderGenerator {
     ...
     * @return
     */
    public String generate(String httpMethod, String url, Map<String, String> requestParams) {
