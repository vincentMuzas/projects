...
(function (global) {
    ...
    var player = {
        ...
        init: function () {
            ...
            this.MiniGrid = utils.createGrid(10, 10);
        },
        ...
        setActiveShipPosition: function (x, y) {
            ...
            var i = - Math.trunc(ship.getLife() / 2);

            while (i < (ship.getLife() - Math.trunc(ship.getLife() / 2))) {
                if (y < 0 || y > 10 || x + i < 0 || x + i > 10)
                    return false;
